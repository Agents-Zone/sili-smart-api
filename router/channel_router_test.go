...
func TestChannelBatchUpdateRouteUsesWritePermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodPost, "/batch/update", authz.ChannelWrite, controller.BatchUpdateChannels)
}
